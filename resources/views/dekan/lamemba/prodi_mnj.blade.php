...
<div class="col-md-12 col-lg-12">
    <div class="card" data-aos="fade-up" data-aos-delay="1000">
        <div class="flex-wrap card-header d-flex justify-content-between">
           ...
           <div class="dropdown">
              <a href="{{url('/masa-studi-lulusan-manajemen')}}" class="btn btn-primary text-white">
                 Lihat Data
              </a>
...
<div class="col-md-12 col-lg-12">
    <div class="card" data-aos="fade-up" data-aos-delay="1000">
        <div class="flex-wrap card-header d-flex justify-content-between">
           ...
           <div class="dropdown">
              <a href="{{url('/waktu-tunggu-lulusan-s1-manajemen')}}" class="btn btn-primary text-white">
                 Lihat Data
              </a>
...
<div class="col-md-12 col-lg-12">
    <div class="card" data-aos="fade-up" data-aos-delay="1000">
        <div class="flex-wrap card-header d-flex justify-content-between">
           ...
           <div class="dropdown">
              <a href="{{url('/waktu-tunggu-lulusan-d4-manajemen')}}" class="btn btn-primary text-white">
                 Lihat Data
              </a>
...
<div class="col-md-12 col-lg-12">
    <div class="card" data-aos="fade-up" data-aos-delay="1000">
        <div class="flex-wrap card-header d-flex justify-content-between">
           ...
           <div class="dropdown">
              <a href="{{url('/kesesuaian-bidang-kerja-manajemen')}}" class="btn btn-primary text-white">
                 Lihat Data
              </a>
...
<div class="col-md-12 col-lg-12">
    <div class="card" data-aos="fade-up" data-aos-delay="1000">
        <div class="flex-wrap card-header d-flex justify-content-between">
           ...
           <div class="dropdown">
              <a href="{{url('/jangkauan-operasi-kerja-manajemen')}}" class="btn btn-primary text-white">
                 Lihat Data
              </a>
...
<div class="col-md-12 col-lg-12">
    <div class="card" data-aos="fade-up" data-aos-delay="1000">
        <div class="flex-wrap card-header d-flex justify-content-between">
           ...
           <div class="dropdown">
              <a href="{{url('/karya-ilmiah-mahasiswa-manajemen')}}" class="btn btn-primary text-white">
                 Lihat Data
              </a>
...
<div class="col-md-12 col-lg-12">
    <div class="card" data-aos="fade-up" data-aos-delay="1000">
        <div class="flex-wrap card-header d-flex justify-content-between">
           ...
           <div class="dropdown">
            <a href="{{url('/produk-jasa-mahasiswa-manajemen')}}" class="btn btn-primary text-white">
               Lihat Data
            </a>
 ...
 <div class="col-md-12 col-lg-12">
    <div class="card" data-aos="fade-up" data-aos-delay="1000">
        <div class="flex-wrap card-header d-flex justify-content-between">
           ...
           <div class="dropdown">
            <a href="{{url('/luaran-mahasiswa-manajemen')}}" class="btn btn-primary text-white">
               Lihat Data
            </a>
 ...
 <div class="col-md-12 col-lg-12">
    <div class="card" data-aos="fade-up" data-aos-delay="1000">
        <div class="flex-wrap card-header d-flex justify-content-between">
           ...
           <div class="dropdown">
            <a href="{{url('/luaran-penelitian-manajemen')}}" class="btn btn-primary text-white">
               Lihat Data
            </a>
 ...
 <div class="col-md-12 col-lg-12">
    <div class="card" data-aos="fade-up" data-aos-delay="1000">
        <div class="flex-wrap card-header d-flex justify-content-between">
           ...
           <div class="dropdown">
            <a href="{{url('/luaran-pkm-manajemen')}}" class="btn btn-primary text-white">
               Lihat Data
            </a>
