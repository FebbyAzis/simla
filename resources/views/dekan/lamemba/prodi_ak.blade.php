      ...
      <div class="row">
          <div class="col-md-12">
              <div class="flex-wrap d-flex justify-content-between align-items-center">
                  <div>
                      <h1>Prodi Akuntansi</h1>
                      <p>Data Luaran Akreditasi pada program studi Akuntansi</p>
                  </div>
              </div>
          </div>
      </div>
...
<div class="col-md-12 col-lg-12">
    <div class="card" data-aos="fade-up" data-aos-delay="1000">
        <div class="flex-wrap card-header d-flex justify-content-between">
           ...
           <div class="dropdown">
              <a href="{{url('/masa-studi-lulusan-akuntansi')}}" class="btn btn-primary text-white">
                 Lihat Data
              </a>
...
<div class="col-md-12 col-lg-12">
    <div class="card" data-aos="fade-up" data-aos-delay="1000">
        <div class="flex-wrap card-header d-flex justify-content-between">
           ...
           <div class="dropdown">
              <a href="{{url('/waktu-tunggu-lulusan-s1-akuntansi')}}" class="btn btn-primary text-white">
                 Lihat Data
              </a>
...
<div class="col-md-12 col-lg-12">
    <div class="card" data-aos="fade-up" data-aos-delay="1000">
        <div class="flex-wrap card-header d-flex justify-content-between">
           ...
           <div class="dropdown">
              <a href="{{url('/waktu-tunggu-lulusan-d4-akuntansi')}}" class="btn btn-primary text-white">
                 Lihat Data
              </a>
...
<div class="col-md-12 col-lg-12">
    <div class="card" data-aos="fade-up" data-aos-delay="1000">
        <div class="flex-wrap card-header d-flex justify-content-between">
           ...
           <div class="dropdown">
              <a href="{{url('/kesesuaian-bidang-kerja-akuntansi')}}" class="btn btn-primary text-white">
                 Lihat Data
              </a>
...
<div class="col-md-12 col-lg-12">
    <div class="card" data-aos="fade-up" data-aos-delay="1000">
        <div class="flex-wrap card-header d-flex justify-content-between">
           ...
           <div class="dropdown">
              <a href="{{url('/jangkauan-operasi-kerja-akuntansi')}}" class="btn btn-primary text-white">
                 Lihat Data
              </a>
...
<div class="col-md-12 col-lg-12">
    <div class="card" data-aos="fade-up" data-aos-delay="1000">
        <div class="flex-wrap card-header d-flex justify-content-between">
           ...
           <div class="dropdown">
              <a href="{{url('/karya-ilmiah-mahasiswa-akuntansi')}}" class="btn btn-primary text-white">
                 Lihat Data
              </a>
...
<div class="col-md-12 col-lg-12">
    <div class="card" data-aos="fade-up" data-aos-delay="1000">
        <div class="flex-wrap card-header d-flex justify-content-between">
           ...
           <div class="dropdown">
            <a href="{{url('/produk-jasa-mahasiswa-akuntansi')}}" class="btn btn-primary text-white">
               Lihat Data
            </a>
 ...
 <div class="col-md-12 col-lg-12">
    <div class="card" data-aos="fade-up" data-aos-delay="1000">
        <div class="flex-wrap card-header d-flex justify-content-between">
           ...
           <div class="dropdown">
            <a href="{{url('/luaran-mahasiswa-akuntansi')}}" class="btn btn-primary text-white">
               Lihat Data
            </a>
 ...
 <div class="col-md-12 col-lg-12">
    <div class="card" data-aos="fade-up" data-aos-delay="1000">
        <div class="flex-wrap card-header d-flex justify-content-between">
           ...
           <div class="dropdown">
            <a href="{{url('/luaran-penelitian-akuntansi')}}" class="btn btn-primary text-white">
               Lihat Data
            </a>
 ...
 <div class="col-md-12 col-lg-12">
    <div class="card" data-aos="fade-up" data-aos-delay="1000">
        <div class="flex-wrap card-header d-flex justify-content-between">
           ...
           <div class="dropdown">
            <a href="{{url('/luaran-pkm-akuntansi')}}" class="btn btn-primary text-white">
               Lihat Data
            </a>
