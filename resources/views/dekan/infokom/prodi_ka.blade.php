      ...
      <div class="row">
          <div class="col-md-12">
              <div class="flex-wrap d-flex justify-content-between align-items-center">
                  <div>
                      <h1>Prodi Komputerisasi Akuntansi</h1>
                      <p>Data Luaran Akreditasi pada program studi Komputerisasi Akuntansi</p>
                  </div>
              </div>
          </div>
      </div>
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card" data-aos="fade-up" data-aos-delay="1000">
                <div class="flex-wrap card-header d-flex justify-content-between">
                   ...
                   <div class="dropdown">
                    <a href="{{url('/ipk-lulusan-komputerisasi-akuntansi')}}" class="btn btn-primary text-white">
                       Lihat Data
                    </a>
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card" data-aos="fade-up" data-aos-delay="1000">
                <div class="flex-wrap card-header d-flex justify-content-between">
                   ...
                   <div class="dropdown">
                    <a href="{{url('/kelulusan-tepat-waktu-komputerisasi-akuntansi')}}" class="btn btn-primary text-white">
                       Lihat Data
                    </a>
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card" data-aos="fade-up" data-aos-delay="1000">
                <div class="flex-wrap card-header d-flex justify-content-between">
                   ...
                   <div class="dropdown">
                    <a href="{{url('/kepuasan-pengguna-lulusan-komputerisasi-akuntansi')}}" class="btn btn-primary text-white">
                       Lihat Data
                    </a>
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card" data-aos="fade-up" data-aos-delay="1000">
                <div class="flex-wrap card-header d-flex justify-content-between">
                   ...
                   <div class="dropdown">
                    <a href="{{url('/masa-tunggu-lulusan-komputerisasi-akuntansi')}}" class="btn btn-primary text-white">
                       Lihat Data
                    </a>
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card" data-aos="fade-up" data-aos-delay="1000">
                <div class="flex-wrap card-header d-flex justify-content-between">
                   ...
                   <div class="dropdown">
                    <a href="{{url('/kesesuaian-bidang-kerja-lulusan-komputerisasi-akuntansi')}}" class="btn btn-primary text-white">
                       Lihat Data
                    </a>
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card" data-aos="fade-up" data-aos-delay="1000">
                <div class="flex-wrap card-header d-flex justify-content-between">
                   ...
                   <div class="dropdown">
                    <a href="{{url('/penelitian-dan-pkm-komputerisasi-akuntansi')}}" class="btn btn-primary text-white">
                       Lihat Data
                    </a>
