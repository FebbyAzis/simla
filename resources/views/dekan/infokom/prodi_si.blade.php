          ...
          <div class="col-md-12">
              <div class="flex-wrap d-flex justify-content-between align-items-center">
                  <div>
                      ...
                      <p>Data Luaran Akreditasi pada program studi Sistem Informasi</p>
                  </div>
              </div>
          </div>
      </div>
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card" data-aos="fade-up" data-aos-delay="1000">
                <div class="flex-wrap card-header d-flex justify-content-between">
                   ...
                   <div class="dropdown">
                    <a href="{{url('/ipk-lulusan-sistem-informasi')}}" class="btn btn-primary text-white">
                       Lihat Data
                    </a>
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card" data-aos="fade-up" data-aos-delay="1000">
                <div class="flex-wrap card-header d-flex justify-content-between">
                   ...
                   <div class="dropdown">
                    <a href="{{url('/kelulusan-tepat-waktu-sistem-informasi')}}" class="btn btn-primary text-white">
                       Lihat Data
                    </a>
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card" data-aos="fade-up" data-aos-delay="1000">
                <div class="flex-wrap card-header d-flex justify-content-between">
                   ...
                   <div class="dropdown">
                    <a href="{{url('/kepuasan-pengguna-lulusan-sistem-informasi')}}" class="btn btn-primary text-white">
                       Lihat Data
                    </a>
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card" data-aos="fade-up" data-aos-delay="1000">
                <div class="flex-wrap card-header d-flex justify-content-between">
                   ...
                   <div class="dropdown">
                    <a href="{{url('/masa-tunggu-lulusan-sistem-informasi')}}" class="btn btn-primary text-white">
                       Lihat Data
                    </a>
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card" data-aos="fade-up" data-aos-delay="1000">
                <div class="flex-wrap card-header d-flex justify-content-between">
                   ...
                   <div class="dropdown">
                    <a href="{{url('/kesesuaian-bidang-kerja-lulusan-sistem-informasi')}}" class="btn btn-primary text-white">
                       Lihat Data
                    </a>
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card" data-aos="fade-up" data-aos-delay="1000">
                <div class="flex-wrap card-header d-flex justify-content-between">
                   ...
                   <div class="dropdown">
                    <a href="{{url('/penelitian-dan-pkm-sistem-informasi')}}" class="btn btn-primary text-white">
                       Lihat Data
                    </a>
