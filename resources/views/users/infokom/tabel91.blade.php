  ...
  <div class="card" data-aos="fade-up" data-aos-delay="900">
    <div class="card-header d-flex justify-content-between">
       <div class="header-title">
          <h4 class="card-title">Tabel Data IPK Lulusan</h4>
       </div>
    </div>
    <div class="card-body">
       <p>Berikut adalah beberapa data IPK Lulusan yang tersimpan dalam SIMLA | UCIC.</p>
       ...
       <div class="table-info">
          <table id="datatable" class="table table-striped" data-toggle="data-table">
            <thead>
              <tr class="table-info">
                  ...
                  <th class="text-center" colspan="3">Indeks Prestasi Kumulatif</th>
          ...
          <tbody>
            ...
            <tr>
                ...
                <td class="text-center">{{$item->ratarata}}</td>
...
<form action="{{url('/tambah-ipk-lulusan')}}" method="POST">
  @csrf
  @method('POST')
      ...
      <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="form-group">
              <p>Isi form dibawah ini untuk menambahkan data IPK Lulusan.</p>
              <div class="col-md-12 p-1">
                ...
                <div class="form-group">
                  <label class="form-label" for="exampleInputText1">Minimal</label>
                  <input type="text" class="form-control" id="exampleInputText1" name="minimal" placeholder="..." required>
                </div>
                <div class="form-group">
                  <label class="form-label" for="exampleInputText1">Rata-rata</label>
                  <input type="text" class="form-control" id="exampleInputText1" name="ratarata" placeholder="..." required>
                </div>
                <div class="form-group">
                  <label class="form-label" for="exampleInputText1">Maksimal</label>
                  <input type="text" class="form-control" id="exampleInputText1" name="maksimal" placeholder="..." required>
                </div>   
...
@foreach ($tabel91 as $item)
<!-- Modal -->
<form action="{{url('edit-ipk-lulusan/'. $item->id)}}" method="POST">
    @csrf
    @method('PUT')
    <div class="modal fade" id="staticBackdrop2{{$item->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog">
          <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                  <p>Ubah form dibawah ini untuk mengedit data IPK Lulusan.</p>
                  <div class="col-md-12 p-1">
                    <div class="form-group">
                      <label class="form-label" for="exampleInputText1">Tahun Lulus</label>
                    ...
                    <div class="form-group">
                      <label class="form-label" for="exampleInputText1">Minimal</label>
                      <input type="text" class="form-control" id="exampleInputText1" name="minimal" value="{{$item->minimal}}" placeholder="..." required>
                    </div>
                    <div class="form-group">
                      <label class="form-label" for="exampleInputText1">Rata-rata</label>
                      <input type="text" class="form-control" id="exampleInputText1" name="ratarata" value="{{$item->ratarata}}" placeholder="..." required>
                    </div>
                    <div class="form-group">
                      <label class="form-label" for="exampleInputText1">Maksimal</label>
                      <input type="text" class="form-control" id="exampleInputText1" name="maksimal" value="{{$item->maksimal}}" placeholder="..." required>
                    </div>
                  </div>
                </div>
              </div>
  ...
  @foreach ($tabel91 as $item)
<!-- Modal -->
<form action="{{url('hapus-ipk-lulusan/'. $item->id)}}" method="POST">
    @csrf
    @method('PUT')
    <div class="modal fade" id="staticBackdrop3{{$item->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog">
          <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                  <p>Apakah anda yakin ingin menghapus IPK Lulusan?</p>
