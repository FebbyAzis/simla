...
<form action="{{url('/tambah-masa-tunggu-lulusan')}}" method="POST">
  @csrf
  @method('POST')
      ...
      <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="form-group">
              <p>Isi form dibawah ini untuk menambahkan data Masa Tunggu Lulusan.</p>
              <div class="col-md-12 p-1">
                ...
                <div class="form-group">
                  <label class="form-label" for="exampleInputText1">Jumlah Lulusan Terlacak</label>
                  <input type="text" class="form-control" id="exampleInputText1" name="jumlah_lulusan_terlacak" placeholder="..." required>
                </div>
                <div class="form-group">
                  <label class="form-label" for="exampleInputText1">Rata-rata Masa Tunggu (Bulan)</label>
                  <input type="text" class="form-control" id="exampleInputText1" name="ratarata_waktu_tunggu" placeholder="..." required>
                </div>
...
@foreach ($tabel94 as $item)
<!-- Modal -->
<form action="{{url('edit-masa-tunggu-lulusan/'. $item->id)}}" method="POST">
    @csrf
    @method('PUT')
    <div class="modal fade" id="staticBackdrop2{{$item->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog">
          <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                  <p>Ubah form dibawah ini untuk mengedit data Masa Tunggu Lulusan.</p>
                  <div class="col-md-12 p-1">
                    <div class="form-group">
                      <label class="form-label" for="exampleInputText1">Tahun Lulus</label>
                    ...
                    <div class="form-group">
                      <label class="form-label" for="exampleInputText1">Rata-rata Masa Tunggu (Bulan)</label>
                      <input type="text" class="form-control" id="exampleInputText1" name="ratarata_waktu_tunggu" value="{{$item->ratarata_waktu_tunggu}}" placeholder="..." required>
                    </div>
                  </div>
                </div>
              </div>
  ...
  @foreach ($tabel94 as $item)
<!-- Modal -->
<form action="{{url('hapus-masa-tunggu-lulusan/'. $item->id)}}" method="POST">
    @csrf
    @method('PUT')
    <div class="modal fade" id="staticBackdrop3{{$item->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog">
          <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                  <p>Apakah anda yakin ingin menghapus Masa Tunggu Lulusan?</p>
