...
<form action="{{url('/tambah-kelulusan-tepat-waktu')}}" method="POST">
  @csrf
  @method('POST')
          ...
          <div class="modal-body">
            <div class="form-group">
              ...
              <div class="col-md-12 p-1">
                ...
                <div class="form-group">
                  <label class="form-label" for="exampleInputText1">Jumlah Mahasiswa yang Masih Aktif</label>
                  <input type="text" class="form-control" id="exampleInputText1" name="jumlah_mahasiswa_aktif" placeholder="..." required>
                </div>
...
@foreach ($tabel92 as $item)
<!-- Modal -->
<form action="{{url('edit-kelulusan-tepat-waktu/'. $item->id)}}" method="POST">
    @csrf
    @method('PUT')
              ...
              <div class="modal-body">
                <div class="form-group">
                  ...
                  <div class="col-md-12 p-1">
                    ...
                    <div class="form-group">
                      <label class="form-label" for="exampleInputText1">Jumlah Mahasiswa yang Masih Aktif</label>
                      <input type="text" class="form-control" id="exampleInputText1" name="jumlah_mahasiswa_aktif" value="{{$item->jumlah_mahasiswa_aktif}}" placeholder="..." required>
                    </div>
                  </div>
                </div>
              </div>
  ...
  @foreach ($tabel92 as $item)
<!-- Modal -->
<form action="{{url('hapus-kelulusan-tepat-waktu/'. $item->id)}}" method="POST">
    @csrf
    @method('PUT')
