      ...
      <div class="row">
          <div class="col-md-12">
              <div class="flex-wrap d-flex justify-content-between align-items-center">
                  <div>
                      <h1>Luaran Mahasiswa</h1>
                      <p>Luaran Penelitian/PkM yang Dihasilkan Mahasiswa (Khusus Program<br>Sarjana/Sarjana Terapan/Magister/Magister Terapan/Doktor/Doktor Terapan)</p>
                  </div>
                  <div>
  ...
  <div class="card" data-aos="fade-up" data-aos-delay="900">
    <div class="card-header d-flex justify-content-between">
       <div class="header-title">
          <h4 class="card-title">Tabel Data Luaran Penelitian/PkM yang Dihsailkan Mahasiswa (Khusus Program Sarjana/Sarjana Terapan/Magister/Magister Terapan/Doktor/Doktor Terapan)</h4>
       </div>
    </div>
    <div class="card-body">
       <p>Berikut adalah beberapa data Luaran Penelitian/PkM yang Dihsailkan Mahasiswa (Khusus Program Sarjana/Sarjana Terapan/Magister/Magister Terapan/Doktor/Doktor Terapan) yang tersimpan dalam SIMLA | UCIC.</p>
      ...
      @endif
       <div class="table-info">
          <table id="datatable" class="table table-striped" data-toggle="data-table">
            <thead>
              <tr class="table-info">
                  ...
                  <th class="text-center p-5">Judul Luaran Penelitian/PkM</th>
                  <th class="text-center p-5">Tahun</th>
                  <th class="text-center p-5">Keterangan</th>
          ...
          <tbody>
            ...
            @foreach ($tabel22 as $no=>$item)
            <tr>
                
                <td class="text-center">{{$no+1}}</td>
                <td class="text-center">{{$item->judul_luaran_penelitian}}</td>
...
<form action="{{url('/tambah-luaran-mahasiswa')}}" method="POST">
  @csrf
  @method('POST')
      ...
      <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="form-group">
              <p>Isi form dibawah ini untuk menambahkan data Luaran Penelitian/PkM yang Dihsailkan Mahasiswa (Khusus Program Sarjana/Sarjana Terapan/Magister/Magister Terapan/Doktor/Doktor Terapan).</p>
              <div class="col-md-12 p-1">
                <div class="form-group">
                  <label class="form-label" for="exampleInputText1">Judul Luaran Penelitian/PkM</label>
                  <input type="text" class="form-control" id="exampleInputText1" name="judul_luaran_penelitian" placeholder="..." required>
                </div>
                <div class="form-group">
...
@foreach ($tabel22 as $item)
<!-- Modal -->
<form action="{{url('edit-luaran-mahasiswa/'. $item->id)}}" method="POST">
    @csrf
    @method('PUT')
    <div class="modal fade" id="staticBackdrop2{{$item->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog">
          <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                  <p>Ubah form dibawah ini untuk mengedit data Luaran Penelitian/PkM yang Dihsailkan Mahasiswa (Khusus Program Sarjana/Sarjana Terapan/Magister/Magister Terapan/Doktor/Doktor Terapan).</p>
                  <div class="col-md-12 p-1">
                    <div class="form-group">
                      <label class="form-label" for="exampleInputText1">Judul Luaran Penelitian/PkM</label>
                      <input type="text" class="form-control" id="exampleInputText1" name="judul_luaran_penelitian" value="{{$item->judul_luaran_penelitian}}" placeholder="..." required>
                    </div>
                    <div class="form-group">
                      <label class="form-label" for="exampleInputText1">Tahun</label>
  ...
  @foreach ($tabel22 as $item)
<!-- Modal -->
<form action="{{url('hapus-luaran-mahasiswa/'. $item->id)}}" method="POST">
    @csrf
    @method('PUT')
    <div class="modal fade" id="staticBackdrop3{{$item->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog">
          <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                  <p>Apakah anda yakin ingin menghapus Luaran Penelitian/PkM yang Dihsailkan Mahasiswa (Khusus Program Sarjana/Sarjana Terapan/Magister/Magister Terapan/Doktor/Doktor Terapan) <b>    </b>?</p>
