      ...
      <div class="row">
          <div class="col-md-12">
              <div class="flex-wrap d-flex justify-content-between align-items-center">
                  <div>
                      <h1>Waktu Tunggu Lulusan D3</h1>
                      <p>Waktu Tunggu Lulusan (Khusus Program Diploma Tiga)</p>
                  </div>
                  <div>
  ...
  <div class="card" data-aos="fade-up" data-aos-delay="900">
    <div class="card-header d-flex justify-content-between">
       <div class="header-title">
          <h4 class="card-title">Tabel Data Waktu Tunggu Lulusan (Khusus Program Diploma Tiga)</h4>
       </div>
    </div>
    <div class="card-body">
       <p>Berikut adalah beberapa data Waktu Tunggu Lulusan (Khusus Program Diploma Tiga) yang tersimpan dalam SIMLA | UCIC.</p>
...
<form action="{{url('/tambah-waktu-tunggu-lulusan-d3')}}" method="POST">
  @csrf
  @method('POST')
      ...
      <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="form-group">
              <p>Isi form dibawah ini untuk menambahkan data Waktu Tunggu Lulusan (Khusus Program Diploma Tiga).</p>
...
@foreach ($tabel12 as $item)
<!-- Modal -->
<form action="{{url('edit-waktu-tunggu-lulusan-d3/'. $item->id)}}" method="POST">
    @csrf
    @method('PUT')
    <div class="modal fade" id="staticBackdrop2{{$item->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog">
          <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                  <p>Ubah form dibawah ini untuk mengedit data Waktu Tunggu Lulusan (Khusus Program Diploma Tiga).</p>
                  <div class="col-md-12 p-1">
                    <div class="form-group">
                      <label class="form-label" for="exampleInputText1">Tahun Lulus</label>
  ...
  @foreach ($tabel12 as $item)
<!-- Modal -->
<form action="{{url('hapus-waktu-tunggu-lulusan-d3/'. $item->id)}}" method="POST">
    @csrf
    @method('PUT')
    <div class="modal fade" id="staticBackdrop3{{$item->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog">
          <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                  <p>Apakah anda yakin ingin menghapus Waktu Tunggu Lulusan (Khusus Program Diploma Tiga)?</p>
