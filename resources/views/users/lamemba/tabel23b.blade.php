      ...
      @endif
       <div class="table-info">
          <table id="datatable" class="table table-striped" data-toggle="data-table">
            <thead>
              <tr class="table-info">
                  ...
                  <th class="text-center p-5" rowspan="2">Luaran PkM</th>
          ...
          <tbody>
            ...
            @foreach ($tabel23b as $no=>$item)
            <tr>
                
                <td class="text-center">{{$no+1}}</td>
                <td class="text-center">{{$item->luaran_pkm}}</td>
...
<form action="{{url('/tambah-luaran-pkm')}}" method="POST">
  @csrf
  @method('POST')
...
@foreach ($tabel23b as $item)
<!-- Modal -->
<form action="{{url('edit-luaran-pkm/'. $item->id)}}" method="POST">
    @csrf
    @method('PUT')
  ...
  @foreach ($tabel23b  as $item)
<!-- Modal -->
<form action="{{url('hapus-luaran-pkm/'. $item->id)}}" method="POST">
    @csrf
    @method('PUT')
