      ...
      <div class="row">
          <div class="col-md-12">
              <div class="flex-wrap d-flex justify-content-between align-items-center">
                  <div>
                      <h1>Masa Studi Lulusan D3</h1>
                      <p>Masa Studi Lulusan Program Studi (Diploma Tiga)</p>
                  </div>
                  <div>
  ...
  <div class="card" data-aos="fade-up" data-aos-delay="900">
    <div class="card-header d-flex justify-content-between">
       <div class="header-title">
          <h4 class="card-title">Tabel Data Masa Studi Lulusan Program Studi (Diploma Tiga)</h4>
       </div>
    </div>
    <div class="card-body">
       <p>Berikut adalah beberapa data Masa Studi Lulusan Program Studi (Diploma Tiga) yang tersimpan dalam SIMLA | UCIC.</p>
          ...
          <table id="datatable" class="table table-striped" data-toggle="data-table">
            <thead>
              <tr class="table-info">
                  ...
                  <th class="text-center" colspan="5">Jumlah Mahasiswa yang Lulus pada</th>
                  ...
                  {{-- <th class="text-center p-5" rowspan="2">Rata- rata Masa Studi</th> --}}
              </tr>
...
<form action="{{url('/tambah-masa-studi-lulusan-d3')}}" method="POST">
  @csrf
  @method('POST')
      ...
      <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="form-group">
              <p>Isi form dibawah ini untuk menambahkan data Masa Studi Lulusan Program Studi (Diploma Tiga).</p>
...
@foreach ($tabel8 as $item)
<!-- Modal -->
<form action="{{url('edit-masa-studi-lulusan-d3/'. $item->id)}}" method="POST">
    @csrf
    @method('PUT')
    <div class="modal fade" id="staticBackdrop2{{$item->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog">
          <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                  <p>Ubah form dibawah ini untuk mengedit data Masa Studi Lulusan Program Studi (Diploma Tiga).</p>
                  <div class="col-md-12 p-1">
                    <div class="form-group">
                      <label class="form-label" for="exampleInputText1">Tahun Masuk</label>
  ...
  @foreach ($tabel8 as $item)
<!-- Modal -->
<form action="{{url('hapus-masa-studi-lulusan-d3/'. $item->id)}}" method="POST">
    @csrf
    @method('PUT')
    <div class="modal fade" id="staticBackdrop3{{$item->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog">
          <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                  <p>Apakah anda yakin ingin menghapus Masa Studi Lulusan Program Studi (Diploma Tiga)?</p>
