      ...
      <div class="row">
          <div class="col-md-12">
              <div class="flex-wrap d-flex justify-content-between align-items-center">
                  <div>
                      <h1>Waktu Tunggu Lulusan D4</h1>
                      <p>Waktu Tunggu Lulusan (Khusus Program Sarjana Terapan)</p>
                  </div>
                  <div>
  ...
  <div class="card" data-aos="fade-up" data-aos-delay="900">
    <div class="card-header d-flex justify-content-between">
       <div class="header-title">
          <h4 class="card-title">Tabel Data Waktu Tunggu Lulusan (Khusus Program Sarjana Terapan)</h4>
       </div>
    </div>
    <div class="card-body">
       <p>Berikut adalah beberapa data Waktu Tunggu Lulusan (Khusus Program Sarjana Terapan) yang tersimpan dalam SIMLA | UCIC.</p>
       ...
       <div class="table-info">
          <table id="datatable" class="table table-striped" data-toggle="data-table">
            <thead>
              ...
              <tr class="table-primary">
                <th class="text-center">WT < 3 Bulan</th>
                <th class="text-center">3 ≤ WT ≤ 6<br>Bulan</th>
          ...
          <tbody>
            ...
            <tr>
                ...
                <td class="text-center">{{$item->wt3bln}}</td>
                <td class="text-center">{{$item->wt3wt_6bln}}</td>
...
<form action="{{url('/tambah-waktu-tunggu-lulusan-d4')}}" method="POST">
  @csrf
  @method('POST')
      ...
      <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="form-group">
              <p>Isi form dibawah ini untuk menambahkan data Waktu Tunggu Lulusan (Khusus Program Sarjana Terapan).</p>
              <div class="col-md-12 p-1">
                ...
                <div class="form-group">
                  <label class="form-label" for="exampleInputText1">WT < 3 Bulan</label>
                  <input type="text" class="form-control" id="exampleInputText1" name="wt3bln" placeholder="..." required>
                </div>
                <div class="form-group">
                  <label class="form-label" for="exampleInputText1">3 ≤ WT ≤ 6 bulan</label>
                  <input type="text" class="form-control" id="exampleInputText1" name="wt3wt_6bln" placeholder="..." required>
                </div>
                <div class="form-group">
...
@foreach ($tabel14 as $item)
<!-- Modal -->
<form action="{{url('edit-waktu-tunggu-lulusan-d4/'. $item->id)}}" method="POST">
    @csrf
    @method('PUT')
    <div class="modal fade" id="staticBackdrop2{{$item->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog">
          <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                  <p>Ubah form dibawah ini untuk mengedit data Waktu Tunggu Lulusan (Khusus Program Sarjana Terapan).</p>
                  <div class="col-md-12 p-1">
                    <div class="form-group">
                      <label class="form-label" for="exampleInputText1">Tahun Lulus</label>
                    ...
                    <div class="form-group">
                      <label class="form-label" for="exampleInputText1">WT < 3 Bulan</label>
                      <input type="text" class="form-control" id="exampleInputText1" name="wt3bln" value="{{$item->wt3bln}}" placeholder="..." required>
                    </div>
                    <div class="form-group">
                      <label class="form-label" for="exampleInputText1">3 ≤ WT ≤ 6 bulan</label>
                      <input type="text" class="form-control" id="exampleInputText1" name="wt3wt_6bln" value="{{$item->wt3wt_6bln}}" placeholder="..." required>
                    </div>
                    <div class="form-group">
                      <label class="form-label" for="exampleInputText1">WT > 6 Bulan</label>
  ...
  @foreach ($tabel14 as $item)
<!-- Modal -->
<form action="{{url('hapus-waktu-tunggu-lulusan-d4/'. $item->id)}}" method="POST">
    @csrf
    @method('PUT')
    <div class="modal fade" id="staticBackdrop3{{$item->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog">
          <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                  <p>Apakah anda yakin ingin menghapus Waktu Tunggu Lulusan (Khusus Program Sarjana Terapan)?</p>
